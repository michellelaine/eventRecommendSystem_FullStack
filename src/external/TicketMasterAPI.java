...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "gyGzSldBWLXAXpItOAvBfrtnvPmzNCVD";
	...
	// Encode keyword in url since it may contain special characters
		...
		// Make url query part e.g.: "apikey=12345&geoPoint=abcd&keyword=music&radius=50"
		...
		try {
			...
			//transfer inputStream to string inputLine, will get a stringBuilder with all event info
			String inputLine;
